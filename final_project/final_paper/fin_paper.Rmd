...
In a next step we identified the language of every tweet [@textcat] and translated those tweets written in European languages other than English into English [@translateR]. Danish and Romanian were excluded from the list because these languages were not adequately identified by the program.
