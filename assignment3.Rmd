...
Since these results are not normalized, it is difficult to is difficult to say how much of the growth of the population of tweets can be attributed to an increase in twitter usage or to an increase of interest in the topic.


```{r cache=FALSE, eval=FALSE, warning=FALSE, echo=FALSE}
