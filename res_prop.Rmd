...
* What can variation across time and space in the volume of tweets regarding the euro crisis tell us about popular awareness or engagement with the issues?
...
Academic research on the emergence of a European public sphere is not a recent phenomenon [@risse2003emerging, 1]. However, this research has been characterized as rather normative as the "research community has been [...] interested in producing policy recommendation for public sphere-building" [@Trenz2015, 234]. Recent studies seem to put emphasis on an empirical grounding of the debate [@Trenz2015, @Drewski2015]. This development is being mirrored in research on the euro crisis. It has been suggested that “there  is  an  emerging  demos  in  the European  polity  and  it  has  been  strengthened 
during the euro crisis” [@risse2014, 1213]. Testing this hypothesis empirically by looking at newspaper editorials, Drewski found that there was significant difference  along  national  instead  of  ideological  lines  in  the discussion  of  the  Euro  crisis. [@Drewski2015, 5]
 
* Variance in Awareness 

Max Hänska and Stefan Bauchowitz in a recent LSE blog entry track twitter activity during the negotiations leading up to the third Greek bailout agreement. [@LSEtwitter] According to their findings, tweets synchronised around key mini-events throughout the negotiations, with peaks and troughs mirrored across national twitter-spheres. From these findings we can take that conversatio

![](img/Greece-twitter-1.jpg)

* Variance in Opinion 

They looked at instances of tweets containing #ThisIsACoup, representing a particular opinion on the agreement. The then showed that the spread of #ThisIsACoup was not reflected in the studied countries equally. This indicated a divergence of public opinion along national lines.
