...
The body of twitter research has constantly grown over the past years (for a comprehensive analysis and typology of twitter research up to 2013, see [@Zimmer2014]). Some of the findings with relevance to our research design are discussed here.

* **Twitter as Platform for Political Delibaration:** Twitter is used as a platform for political deliberation. In a recent study, Tumasjan et al. found that the mere number of tweets reflects voter preferences and came close to traditional election polls, while the sentiment of Twiter messages closely corresponded to political programs, candidate profiles, and evidence from the media coverage of the campaign trail [@tumasjan2010, 183].

* **Twitter Usage in Critical Situations:** Twitter usage in critical situations has been found to differ from general twitter usage. In a study on twitter usage at high-profile mass convergence events and catastrophes Hughes and Palen found that during mass convergence and crisis events, where the user is pushing information out to many users and not directing it toward one specific user, more broadcast-based information sharing activities happen [@Hughes2009, 259]. As for a difference in between natural catastrophes and political events, they found that there was less information sharing (measured by instances of URLs) in politcal conventions than in natural catastrophes [@Hughes2009, 257]. 
* **Geolocation:** Devin Gaffney tested the degree to which geographic, semantic, and social distances impact the frequency of interactions between users (used information from geolocated tweets). [@Number2012]


* **Sentiment Analysis:** Though the field of Sentiment Analysis (SA) is perhaps most developed in the business world [@Zimmer2014, 250], an increasing body of literature has developed, focused on retrieving information about political opinions from the Twittersphere. Tumasjan et. al's landmark paper, "Predicting Elections from Twitter: What 140 Characters Reveal about Political Sentiment", analysed the possibility of using twitter data to predict the 2009 German election [@tumasjan2010]. Though the results have come under scrutiny [see @jungherr2012pirate], the authors found that 
...
* **Ethical Aspects:** Finally, there is some studies discuss ethical aspects of twitter research. For example, concerns about creating a permanent archive of tweets have been voiced. These concerns included whether "such archive was aligned with users’ privacy expectations" [@Zimmer2014, 258], [@Zimmer2010]
